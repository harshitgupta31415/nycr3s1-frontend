...
export const metadata: Metadata = { title: "Evidence Reports | RollbackReady", description: "Review RollbackReady migration safety evidence dimensions and verdict boundaries." };

export default function ReportsPage() {
  return <FeaturePage eyebrow="EVIDENCE REPORTS / EXPLAINABLE VERDICTS" title="A verdict is only useful" accent="when you can inspect why." summary="RollbackReady reports schema replay, data integrity, backward compatibility, interruption behavior, recovery execution, and limitations independently. Not tested never becomes pass, and verified never becomes safe to deploy." metric="24h" metricLabel="Report retention" variant="reports" stages={[
