...
export const metadata: Metadata = { title: "Product | RollbackReady", description: "How RollbackReady turns Prisma migrations into deterministic recovery evidence." };

export default function ProductPage() {
  return <FeaturePage eyebrow="PRODUCT / MIGRATION INTELLIGENCE" title="From migration file to" accent="verified evidence." summary="RollbackReady reconstructs the real migration boundary: complete history, synthetic production-shaped data, legacy query contracts, interruption experiments, and a recovery plan that must execute successfully." metric="4" metricLabel="Risk families" variant="product" stages={[
